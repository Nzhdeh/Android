...
public class DetalleFragment extends Fragment {
    ...
    private TextView nombreEquipo,descripcion;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nombreEquipo = vista.findViewById(R.id.detalleNombreEquipo);
        imagenEquipo = vista.findViewById(R.id.detalleImagen);
        descripcion = vista.findViewById(R.id.detalleDetalles);
...
//        fragmentTransaction.replace(R.id.fragmentContenedor,df).commit();
...
//    public void cargar()
//    {
//        nombreEquipo.setText(jugador.getNombreEquipo());
//        descripcion.setText(jugador.getDetalles());
//        imagenEquipo.setImageResource(jugador.getImagen());
//    }
    // TODO: Rename method, update argument and hook method into UI event
//    public void onButtonPressed(Uri uri) {
//        if (actividad != null) {
//            actividad.onFragmentInteraction(uri);
//        }
//    }
